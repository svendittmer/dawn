export default class Ship {
  ...
  constructor(mesh: BABYLON.Mesh, scene: BABYLON.Scene) {
    ...
    const action = new BABYLON.InterpolateValueAction(
      BABYLON.ActionManager.OnPickTrigger, this._mesh, "visibility", 0.2, 1000);
    const action2 = new BABYLON.InterpolateValueAction(
      BABYLON.ActionManager.OnPickTrigger, this._mesh, "visibility", 1.0, 1000);
